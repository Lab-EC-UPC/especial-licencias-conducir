import {type PeruRegion, peruRegions} from "@/features/06-Lesiones-Muertes-Nacionales/utils/peruRegions.ts";
...
export const MapaChart = () => {
  ...
  return (
    <div className="flex items-center h-full justify-center relative scrollbar-hidden py-8 md:py-4">
      {hoveredRegion && (
        <div
          ref={tooltipRef}
